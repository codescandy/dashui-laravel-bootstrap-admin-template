@extends('layouts.default', ['page' => 'billing', 'page_group' => 'pages'])
@section('title')
    Billing
@endsection
@section('content')
                    ...
                    <div class="col-12 mb-6">
                        ...
                        <div class="card">
                            ...
                            <div class="card-body">
                                ...
                                <div class="row">
                                    <div class="col-xl-8 col-lg-6 col-md-12 col-12">
                                        <div class="mb-2">
                                            ...
                                            <p>Unlimited access to essential tools for design, bootstrap themes, illustrator
                                                and icons.
                                            </p>
                                            <p><i data-feather="info"
                                                    class="me-2 text-muted
                                icon-xs"></i>Next Payment: on <span class="text-primary">$499.00 USD</span><span
                                                    class="text-dark fw-bold"> Jan 1, 2022</span></p>
                                        </div>
                                    </div>
                                    <!-- col  -->
                              ...
                              text-primary-hover d-block">Learn
                                                more about our
                                                membership
                                                policy</a>
                                            <a href="#" class="btn btn-dark d-grid mb-2" data-bs-toggle="modal"
                        ...
                        align-items-center">
                                    ...
                                    <div class="mb-3 mb-lg-0 text-center text-sm-start">
                                        ...
                                        <div class="mt-2">
                                            <img src="../assets/images/creditcard/mastercard.svg" alt=""> <span
                                                class="fw-bold">***8773</span>
                                        </div>
                                    </div>
                            ...
                            <div class="card-body">
                                <div class="row align-items-center">
                                  ...
                                  fw-medium fs-4">Valarie
                                                    ...
                                                    <a href="#"
                                                        class="me-2 text-muted
                                  text-primary-hover">Remove
                                                        as Default Billing</a>
                                                </label>
                                            </div>
                                        </div>
                                    </div>
                          ...
                          justify-content-lg-end">
                                    ...
                                    <div class="col-12">
                                        ...
                                        <a href="#" class="btn btn-primary" data-bs-toggle="modal"
                                            data-bs-target="#billingAddressModal">Add New Address</a>
                                    </div>
                                </div>
                            </div>
            ...
            <div class="modal-content">
                ...
                <div class="modal-body p-5">
                  ...
                  align-items-center">
                                <div>
                                    <div class="form-check ">
                                        <input type="radio" id="customRadioStandard" name="customRadio"
                                            class="form-check-input">
                  ...
                  align-items-center">
                                <div>
                                    <div class="form-check ">
                                        <input type="radio" id="customRadioMultiside" name="customRadio"
                                            class="form-check-input">
                  ...
                  align-items-center">
                                <div>
                                    <div class="form-check ">
                                        <input type="radio" id="customRadioExtended" name="customRadio"
                                            class="form-check-input">
    ...
    <div class="modal fade" id="billingAddressModal" tabindex="-1" aria-labelledby="billingAddressModalLabel"
        aria-hidden="true">
        <div class="modal-dialog modal-dialog-centered modal-lg">
            <div class="modal-content">
                ...
                <div class="modal-body p-5">
                    <form class="row">
                        ...
                        <div class="mb-3 col-12">
                            ...
                            <input type="text" class="form-control" placeholder="123 Ocean Ave" id="addressOne"
                                required>

                        </div>
                        <div class="mb-3 col-12">
                            <label for="addressTwo" class="form-label">Address line 2</label>
                            <input type="text" class="form-control" placeholder="123 Ocean Ave" id="addressTwo"
                                required>
