@extends('layouts.default', ['page' => 'settings', 'page_group' => 'pages'])
@section('title')
    Setting
@endsection
@section('content')
                        ...
                        <div class="row align-items-center mb-8">
                            ...
                            <div class="col-md-9">
                                <div class="d-flex align-items-center">
                                    <div class="me-3">
                                        <img src="{{ Vite::asset('resources/images/avatar/avatar-5.jpg') }}" alt="avatar"
                          ...
                          form-label">Address line
                                ...
                                <div class="mb-3 row">
                                    <label for="addressLineTwo"
                                        class="col-sm-4
                          col-form-label form-label">Address line
                                        2</label>
                                    <div class="col-md-8 col-12">
                                        <input type="text" class="form-control" placeholder="placeholder"
                                ...
                                <div class="row align-items-center">
                                    <label for="zipcode"
                                        class="col-sm-4 col-form-label
                          form-label">Zip code <i
                                            data-feather="info" class="me-2 icon-xs"></i></label>
                        ...
                        col-form-label form-label">New password</label>
                            ...
                            <div class="row align-items-center">
                                <label for="confirmNewpassword"
                                    class="col-sm-4
                        col-form-label form-label">Confirm new
                                    password</label>
                ...
                <div class="card" id="preferences">
                    <div class="card-body">
                        ...
                        form-label">Date Format</label>
                          ...
                          form-check-inline">
                                        <input type="radio" id="customRadioInlineOn" name="customRadioInline"
                                    ...
                                    <div class="form-check custom-radio
                          form-check-inline">
                                        <input type="radio" id="customRadioInlineOff" name="customRadioInline"
                                            class="form-check-input">
            ...
            <div class="col-xl-9 col-lg-8 col-md-12 col-12">
                ...
                <div class="card mb-6">
                    ...
                    <div class="card-body">
                        ...
                        <div>
                            <!-- text -->
                            <p>Delete any and all content you have, such as articles, comments, your reading list or chat
                                messages. Allow your username to become available to anyone.</p>
