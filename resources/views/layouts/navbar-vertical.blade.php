 ...
 <nav class="navbar-vertical navbar">
     <div class="nav-scroller" data-simplebar>
         <!-- Brand logo -->
             ...
             <li class="nav-item">
                 ...
                 <div id="navAuthentication"
                     ...
                     <ul class="nav flex-column">
                         ...
                         <li class="nav-item">
                             <a class="nav-link {{$page === 'forgot-password' ? 'active' : ''}}"
                     ...
                     <ul class="nav flex-column">
                         ...
                         <li class="nav-item">
                             ...
                             <div id="navMenuLevelThree"
                                 class="collapse @@if (context.page_group === 'threelevel') { collapsed }"
                                 ...
                                 <ul class="nav flex-column">
                                     <li class="nav-item">
                                         ...
                                         <div id="navMenuLevelThreeOne"
                                             class="collapse collapse @@if (context.page_group === 'navitemthree1') { collapsed }"
