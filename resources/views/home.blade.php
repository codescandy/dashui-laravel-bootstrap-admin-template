                            ...
                            <tbody>
                                    ...
                                    <td class="align-middle">
                                        <div class="avatar-group">
                                            <span class="avatar avatar-sm">
                                                <img src="{{ Vite::asset('resources/images/avatar/avatar-1.jpg') }}" alt="avatar" class="rounded-circle" />
                                            </span>
                                            <span class="avatar avatar-sm">
                                                <img src="{{ Vite::asset('resources/images/avatar/avatar-2.jpg') }}" alt="avatar" class="rounded-circle"/>
                                            </span>
                                            <span class="avatar avatar-sm">
                                                <img src="{{ Vite::asset('resources/images/avatar/avatar-3.jpg') }}" alt="avatar" class="rounded-circle"/>
                                            </span>
                                ...
                                <tr>
                                    <td class="align-middle">
                                        <div class="d-flex align-items-center">
                                            <div>
                                                <div class="icon-shape icon-md border p-4 rounded-1">
                                                    <img src="{{ Vite::asset('resources/images/brand/slack-logo.svg') }}" alt=""/>
                                                </div>
                                            </div>
                                            <div class="ms-3 lh-1">
                                    ...
                                    <td class="align-middle">
                                        <div class="avatar-group">
                                            <span class="avatar avatar-sm">
                                                <img src="{{ Vite::asset('resources/images/avatar/avatar-4.jpg') }}" alt="avatar" class="rounded-circle"/>
                                            </span>
                                            <span class="avatar avatar-sm">
                                                <img src="{{ Vite::asset('resources/images/avatar/avatar-5.jpg') }}" alt="avatar" class="rounded-circle"/>
                                            </span>
                                            <span class="avatar avatar-sm">
                                                <img src="{{ Vite::asset('resources/images/avatar/avatar-6.jpg') }}" alt="avatar" class="rounded-circle"/>
                                            </span>
                                            <span class="avatar avatar-sm avatar-primary">
                                                <span class="avatar-initials rounded-circle fs-6">+5</span>
                                            </span>
                                ...
                                <tr>
                                    <td class="align-middle">
                                        <div class="d-flex align-items-center">
                                            <div>
                                                <div class="icon-shape icon-md border p-4 rounded-1">
                                                    <img src="{{ Vite::asset('resources/images/brand/github-logo.svg') }}" alt="" />
                                                </div>
                                            </div>
                                            <div class="ms-3 lh-1">
                                    ...
                                    <td class="align-middle">
                                        <div class="avatar-group">
                                            <span class="avatar avatar-sm">
                                                <img src="{{ Vite::asset('resources/images/avatar/avatar-7.jpg') }}" alt="avatar" class="rounded-circle" />
                                            </span>
                                            <span class="avatar avatar-sm">
                                                <img src="{{ Vite::asset('resources/images/avatar/avatar-8.jpg') }}" alt="avatar" class="rounded-circle"/>
                                            </span>
                                            <span class="avatar avatar-sm">
                                                <img src="{{ Vite::asset('resources/images/avatar/avatar-9.jpg') }}" alt="avatar" class="rounded-circle"/>
                                            </span>
                                            <span class="avatar avatar-sm avatar-primary">
                                ...
                                <tr>
                                    <td class="align-middle">
                                        <div class="d-flex align-items-center">
                                            <div>
                                                <div class="icon-shape icon-md border p-4 rounded-1">
                                                    <img src="{{ Vite::asset('resources/images/brand/3dsmax-logo.svg') }}" alt="" />
                                                </div>
                                            </div>
                                            <div class="ms-3 lh-1">
                                    ...
                                    <td class="align-middle">
                                        <div class="avatar-group">
                                            <span class="avatar avatar-sm">
                                                <img src="{{ Vite::asset('resources/images/avatar/avatar-10.jpg') }}" alt="avatar" class="rounded-circle"/>
                                            </span>
                                            <span class="avatar avatar-sm">
                                                <img src="{{ Vite::asset('resources/images/avatar/avatar-11.jpg') }}" alt="avatar" class="rounded-circle"/>
                                            </span>
                                            <span class="avatar avatar-sm">
                                                <img src="{{ Vite::asset('resources/images/avatar/avatar-12.jpg') }}" alt="avatar" class="rounded-circle"/>
                                            </span>
                                            <span class="avatar avatar-sm avatar-primary">
                                                <span class="avatar-initials rounded-circle fs-6">+5</span>
                                            </span>
                                ...
                                <tr>
                                        ...
                                        <div class="d-flex align-items-center">
                                            <div>
                                                <div class="icon-shape icon-md border p-4 rounded bg-primary">
                                                    <img src="{{ Vite::asset('resources/images/brand/layers-logo.svg') }}" alt="" />
                                                </div>
                                            </div>
                                            <div class="ms-3 lh-1">
                                                <h5 class=" mb-1"> <a href="#" class="text-inherit">Webapp DesignSystem</a></h5>
                                            </div>
                                        </div>
                                    </td>
                                    ...
                                    <td class="align-middle">
                                        <div class="avatar-group">
                                            <span class="avatar avatar-sm">
                                                <img src="{{ Vite::asset('resources/images/avatar/avatar-13.jpg') }}" alt="avatar" class="rounded-circle"/>
                                            </span>
                                            <span class="avatar avatar-sm">
                                                <img src="{{ Vite::asset('resources/images/avatar/avatar-14.jpg') }}" alt="avatar" class="rounded-circle"/>
                                            </span>
                                            <span class="avatar avatar-sm">
                                                <img src="{{ Vite::asset('resources/images/avatar/avatar-15.jpg') }}" alt="avatar" class="rounded-circle"/>
                                            </span>
                                            <span class="avatar avatar-sm avatar-primary">
                                                <span class="avatar-initials rounded-circle fs-6">+5</span>
                                            </span>
                            ...
                            <tbody>
                                <tr>
                                    <td class="align-middle">
                                        <div class="d-flex align-items-center">
                                            <div>
                                                <img src="{{ Vite::asset('resources/images/avatar/avatar-2.jpg') }}" alt="" class="avatar-md avatar rounded-circle"/>                                                
                                            </div>
                                            <div class="ms-3 lh-1">
                                ...
                                <tr>
                                    <td class="align-middle">
                                        <div class="d-flex align-items-center">
                                            <div>
                                                <img src="{{ Vite::asset('resources/images/avatar/avatar-1.jpg') }}" alt="" class="avatar-md avatar rounded-circle" />
                                            </div>
                                            <div class="ms-3 lh-1">
                                ...
                                <tr>
                                    <td class="align-middle">
                                        <div class="d-flex align-items-center">
                                            <div>
                                                <img src="{{ Vite::asset('resources/images/avatar/avatar-3.jpg') }}" alt="" class="avatar-md avatar rounded-circle"/>
                                            </div>
                                            <div class="ms-3 lh-1">
                                ...
                                <tr>
                                    <td class="align-middle">
                                        <div class="d-flex align-items-center">
                                            ...
                                            <div>
                                                <img src="{{ Vite::asset('resources/images/avatar/avatar-4.jpg') }}" alt="" class="avatar-md avatar rounded-circle"/>
                                            </div>
                                ...
                                <tr>
                                    ...
                                    <td class="align-middle">
                                        <div class="d-flex align-items-center">
                                            ...
                                            <div>
                                                <img src="{{ Vite::asset('resources/images/avatar/avatar-5.jpg') }}" alt="" class="avatar-md avatar rounded-circle"/>
                                            </div>
                                ...
                                <tr>
                                    <td class="align-middle border-bottom-0">
                                        <div class="d-flex align-items-center">
                                            <div>
                                                <img src="{{ Vite::asset('resources/images/avatar/avatar-6.jpg') }}" alt="" class="avatar-md avatar rounded-circle"/>
                                            </div>
                                            <div class="ms-3 lh-1">
