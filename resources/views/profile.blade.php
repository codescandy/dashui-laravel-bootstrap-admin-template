@extends('layouts.default', ['page' => 'profile','page_group' => 'pages'])
@section('title')
    Overview
@endsection
@section('content')
        ...
        <div class="row align-items-center">
            <div class="col-xl-12 col-lg-12 col-md-12 col-12">
                ...
                <div class="pt-20 rounded-top"
                    style="background:url({{ Vite::asset('resources/images/background/profile-cover.jpg') }}) no-repeat; background-size: cover;">
                </div>
                    ...
                    <div class="d-flex align-items-center justify-content-between pt-4 pb-6 px-4">
                        <div class="d-flex align-items-center">
                            ...
                            <div
                                ...
                                <img src="{{ Vite::asset('resources/images/avatar/avatar-1.jpg') }}" alt="avatar"
                                ...
                                <a href="#!" class="position-absolute top-0 right-0 me-2" data-bs-toggle="tooltip"
                                    ...
                                    <img src="{{ Vite::asset('resources/images/svg/checked-mark.svg') }}" alt=""
                                        height="30" width="30" />
                                </a>
                            </div>
                            <!-- text -->
                        ...
                        <div>
                            <a href="#" class="btn btn-outline-primary d-none d-md-block">Edit
                                Profile
                            </a>
                        </div>
                    </div>
            ...
            <div class="row">
                ...
                align-items-center mb-4">
                                <div class="d-flex align-items-center">
                                    ...
                                    <!-- text -->
                                    <div class="ms-3 ">
                                        <h5 class="mb-1"><a href="#" class="text-inherit">Design 3d Character</a>
                                        </h5>
                                        <p class="mb-0 fs-5 text-muted">Project description and details about...</p>
                                    </div>
                                </div>
                                ...
                                <div class="d-flex align-items-center ms-10 ms-md-0 mt-3">
                                    ...
                                    <div>
                                        ...
                                        <div class="dropdown dropstart">
                                            <a href="#" class="text-muted text-primary-hover"
                                                id="dropdownprojectTwo" data-bs-toggle="dropdown" aria-haspopup="true"
                                                aria-expanded="false">
                                                <i data-feather="more-vertical" class="icon-xxs"></i>
                                            </a>
                ...
                align-items-center mb-4">
                                <div class="d-flex align-items-center">
                                    ...
                                    <!-- text -->
                                    <div class="ms-3 ">
                                        <h5 class="mb-1"><a href="#" class="text-inherit">Github Development</a>
                                        </h5>
                                        <p class="mb-0 fs-5 text-muted">Project description and details about...</p>
                                    </div>
                                </div>
                                <div class="d-flex align-items-center ms-10 ms-md-0 mt-3">
                                    ...
                                    <div>
                                        ...
                                        <div class="dropdown dropstart">
                                            <a href="#" class="text-muted text-primary-hover"
                                                id="dropdownprojectThree" data-bs-toggle="dropdown" aria-haspopup="true"
                                                aria-expanded="false">
                                                <i data-feather="more-vertical" class="icon-xxs"></i>
                                            </a>
                ...
                align-items-center mb-4">
                                ...
                                <div class="d-flex align-items-center ms-10 ms-md-0 mt-3">
                                    ...
                                    <div>
                                        ...
                                        <div class="dropdown dropstart">
                                            <a href="#" class="text-muted text-primary-hover"
                                                id="dropdownprojectFour" data-bs-toggle="dropdown" aria-haspopup="true"
                                                aria-expanded="false">
                                                <i data-feather="more-vertical" class="icon-xxs"></i>
                                            </a>
                ...
                align-items-center">
                                <div class="d-flex align-items-center">
                                    <!-- icon shape -->
                                    <div>
                                        <div class="icon-shape icon-lg border p-4 rounded-1 bg-primary">
                                    ...
                                    <!-- text -->
                                    <div class="ms-3 ">
                                        <h5 class="mb-1"><a href="#" class="text-inherit">Project Management</a>
                                        </h5>
                                        <p class="mb-0 fs-5 text-muted">Project description and details about...</p>
                                    </div>
                                </div>
                                <div class="d-flex align-items-center ms-10 ms-md-0 mt-3">
                                    ...
                                    <div>
                                        ...
                                        <div class="dropdown dropstart">
                                            <a href="#" class="text-muted text-primary-hover"
                                                id="dropdownprojectFoufive" data-bs-toggle="dropdown"
                ...
                <div class="col-xl-6 col-md-12 col-12 mb-6">
                    ...
                    <div class="card">
                        ...
                        <div class="card-body">
                            ...
                            <div class="mb-4">
                                <!-- text -->
                                <p class="mb-4">Lorem ipsum dolor sit amet, consectetur adipiscing elit. Suspen disse var
                                    ius enim in eros elementum tristique. Duis cursus, mi quis viverra ornare, eros dolor
                                    interdum nulla, ut commodo diam libero vitae erat.</p>
                                <img src="{{ Vite::asset('resources/images/blog/blog-img-1.jpg') }}" alt=""
                            ...
                            <div class="mb-4">
                                ...
                                <span class="me-1 me-md-4"><i data-feather="message-square"
                                        class="icon-xxs text-muted me-2"></i>
                                    <span>12 Comment</span>
                                </span>
                                <span><i data-feather="share-2"
                                        class="icon-xxs text-muted me-2"></i><span>Share</span></span>
                            </div>
                            ...
                            <div class="row">
                                <div class="col-xl-1 col-lg-2 col-md-2 col-12 mb-3 mb-lg-0">
                                    <!-- avatar -->
                                    <img src="{{ Vite::asset('resources/images/avatar/avatar-15.jpg') }}" alt=""
                    ...
                    <div class="card mb-4">
                        ...
                        <div class="card-body">
                            ...
                            <div class="d-flex justify-content-between align-items-center mb-4">
                                ...
                                <div>
                                    <a href="#" class="text-muted text-primary-hover"><i class="me-4 icon-xs"
                                            data-feather="phone-call"></i></a>
                                    <a href="#" class="text-muted text-primary-hover"><i class="icon-xs"
                            ...
                            <div class="card">
                                ...
                                <div class="card-body">
                                    ...
                                    <div class="d-flex mb-5">
                                        ...
                                        <div class="ms-3 ">
                                            <h5 class="mb-1">Dianna Smiley</h5>
                                            <p class="text-muted mb-2">Just create a new Project in Dashui...</p>
                                    ...
                                    <div class="d-flex">
                                        ...
                                        <div class="ms-3 ">
                                            ...
                                            <p class="text-muted mb-2">Just share your article on Social Media..</p>
